...
export class DashboardViewModel extends BaseViewModel {
    ...
    public renderContent(ViewModel: new (context?: PageJS.Context) => BaseViewModel, context?: PageJS.Context): BaseViewModel {
...
export const routes = [
    ...
    // Destructive action with confirmation guard
    {
        ...
        middleware: [
            authMiddleware, 
            confirmationGuard('Are you sure you want to delete your account? This action cannot be undone.')
        ],
